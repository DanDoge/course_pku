...
## Nickname :                                                      #
## UserID   :                                                      #
## implementation of iaddl and leave the same as in part-b         #
## descriptions shown as follow                                    #
####################################################################
##            IADDL                #             ILEAVE            #
##fetch                            #fetch                          #
...
##execute                          #execute                        #
## valE       = valC + valB        # valE       = valB + 4         #
##memory                           #memory                         #
##                                 # valM       = M[valA]          #
##write back                       #write back                     #
## R[rB]      = valE               # R[%esp]    = valE             #
##                                 # R[%ebp]    = valM             #
##update PC                        #update PC                      #
## PC         = valP               # PC         = valP             #
####################################################################
...
int d_dstE = [
	D_icode in { IRRMOVL, IIRMOVL, IOPL
#add oct 30
	, IIADDL } : D_rB;
	D_icode in { IPUSHL, IPOPL, ICALL, IRET
#add oct 30
	, ILEAVE} : RESP;
...
int aluA = [
	...
	E_icode in { IIRMOVL, IRMMOVL, IMRMOVL
#add oct 30
	, IIADDL} : E_valC;
	E_icode in { ICALL, IPUSHL } : -4;
	E_icode in { IRET, IPOPL
#add oct 30
	, ILEAVE} : 4;

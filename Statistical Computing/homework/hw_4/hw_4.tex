...
\begin{equation}
    \begin{aligned}
        ...
        \nabla_{\sigma^2} \log p(x, g_{\mu, \sigma^2}(\epsilon)) &= \sum_{i} y_{i} \frac{\sigma (1 - \sigma)}{\sigma} \epsilon x_{i} + (1 - y_{i}) \frac{- \sigma (1 - \sigma)}{1 - \sigma} \epsilon x_{i} - (\mu + \sigma \epsilon) \epsilon \\
        &= \epsilon \sum_{i} y_{i} (1 - \sigma) x_{i} + (y_{i} - 1) \sigma x_{i} - (\mu + \sigma \epsilon) \\
